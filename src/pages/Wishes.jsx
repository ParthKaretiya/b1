...
export default function Wishes() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('bhavya_wishes');
    if (saved) {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('bhavya_wishes', JSON.stringify(updatedWishes));
        ...
        >
          ...
          <p className="font-body text-cream/60 max-w-xl mx-auto text-lg leading-relaxed">
            ...
            <span className="text-sm italic opacity-70">
              (Wishes are saved locally on your device)
            </span>
          </p>
        </motion.div>
            ...
            <div className="glass-card p-6 md:p-8 rounded-3xl relative overflow-hidden border border-warm-gold/20">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span>{wishes.length} wishes sent</span>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <div
                        className={`absolute left-0 top-0 bottom-0 w-1.5 rounded-l-2xl ${
                          justPosted === wish.id ? 'bg-gradient-to-b from-warm-gold via-pink-400 to-warm-gold' : 'bg-warm-gold'
                        }`}
                      />
